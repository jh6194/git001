...
public class BoardPagingDto {
	...
	private ArrayList<NoticeBoardDto> list10;
	...
	public BoardPagingDto(int pstartno) {
		PagingDao dao = new PagingDao();
		this.pageTotal = dao.boardlistSum();	// 전체 레코드수
		this.onePageLimit = 20;	// 한페이지당 보여주는 레코드수
		...
		this.list10 = dao.boardlistpage(pstartno);	// 현재보여줄 페이지 글 개수
		//현재버튼	
	...
	public BoardPagingDto(int pageTotal, int onePageLimit, int pageAll, int bottomlist, int startBtn, int endBtn,
			int currentBtn, ArrayList<NoticeBoardDto> list10, int pstartno) {
		super();
	...
	public ArrayList<NoticeBoardDto> getList10() {
		return list10;
	}

	public void setList10(ArrayList<NoticeBoardDto> list10) {
		this.list10 = list10;
	}
