...
<body>
	...
	<div class = "row">
		...
		<div class = "col-sm-8 text-center">
			<input type = "reset" class = "btn btn-default" value = "아이디 찾기" id = "btn1"/>
			<a href = "findPopPassView.we" class = "btn btn-default">비밀번호 찾기</a>
		</div>
		<div class = "col-sm-2"></div>
	</div>
	...
	<form action="findPopIdDo.we" method = "post" id = "findIdForm">
		<fieldset>
	...
	<div class = "row container">
		...
		<div class = "col-sm-8 form-group">
			...
			<input class = "form-control input-lg" type = "text" id = "findIdName" name = "findIdName" placeholder = "이름을 입력해주세요."/>
		</div>
		<div class = "col-sm-2"></div>
	</div>
	...
	<div class = "row container">
		...
		<div class = "col-sm-8 form-group">
			...
			<input class = "form-control input-lg" type = "email" id = "findIdEmail" name = "findIdEmail" placeholder = "이메일을 입력해주세요."/>
		</div>
		<div class = "col-sm-2"></div>
	</div>
