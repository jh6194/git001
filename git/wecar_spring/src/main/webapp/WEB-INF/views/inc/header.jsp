  ...
  <div class="container-fluid">
    <div class = "col-sm-4 clearfix">
    	<h1 class = "logo text-center">
			<a class="navbar-brand" href = "${pageContext.request.contextPath}/main/view" title = "사이트홈페이지로 바로가기 링크">
				<img alt="위카" src="${pageContext.request.contextPath}/resources/LOGO.png">
			</a>
		</h1>
    </div>
    ...
    <ul class="nav-menu nav navbar-nav">
		<li><a href="https://jh6194.cafe24.com/wecar/noticeList.board">공지사항</a></li>
		<li><a href="https://jh6194.cafe24.com/wecar/list.car">차량관리</a></li>
		<li><a href="https://jh6194.cafe24.com/wecar/list.reserve">예약관리</a></li>
		<li><a style="color:orange;" href="https://jh6194.cafe24.com/wecar/eventList.board">피드백</a></li>
    </ul>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right nav-submenu">   
      ...
      <li><a href="https://jh6194.cafe24.com/wecar/logout.we">로그아웃</a></li>
      <li><a href="https://jh6194.cafe24.com/wecar/userList.manager">회원관리</a></li>
      <li><a href="https://jh6194.cafe24.com/wecar/serviceCenter.we">고객센터</a></li>
    </ul>
    </div>
    </c:when>
    ...
    <ul class="nav-menu nav navbar-nav">
		<li><a href="https://jh6194.cafe24.com/wecar/noticeList.board">공지사항</a></li>
		<li><a href="https://jh6194.cafe24.com/wecar/search.car">예약하기</a></li>
		<li><a href="https://jh6194.cafe24.com/wecar/list.reserve">예약확인</a></li>
		<li><a style="color:orange;" href="https://jh6194.cafe24.com/wecar/eventList.board">피드백</a></li>
    </ul>
    </div>
    ...
    <ul class="nav navbar-nav navbar-right nav-submenu">   
      ...
      <li><a href="https://jh6194.cafe24.com/wecar/logout.we">로그아웃</a></li>
      <li><a href="https://jh6194.cafe24.com/wecar/mypageView.we">마이페이지</a></li>
      <li><a href="https://jh6194.cafe24.com/wecar/serviceCenter.we">고객센터</a></li>
    </ul>
    </div>
    </c:when>
    ...
    <div class = "col-sm-3 clearfix">
    <ul class="nav navbar-nav navbar-right nav-submenu">   
      <li><a href="https://jh6194.cafe24.com/wecar/loginView.we">로그인</a></li>
      <li><a href="https://jh6194.cafe24.com/wecar/serviceCenter.we">고객센터</a></li>
    </ul>
    </div>
	</c:otherwise>    
